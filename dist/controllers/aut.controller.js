...
exports.singin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!user)
                    return [2 /*return*/, res.status(400).json("correo invalido")];
                return [4 /*yield*/, user.validatePassword(req.body.password)];
            case 2:
                password = _a.sent();
                if (!password)
                    return [2 /*return*/, res.status(400).json('contraseña incorrecta')];
